...
func main() {
	...
	http.HandleFunc("/api/admin/orders/update", limit(requirePermission("orders", handleAdminOrdersUpdate)))
	http.HandleFunc("/api/admin/orders/history", limit(requirePermission("orders", handleAdminOrderHistory)))
	http.HandleFunc("/api/admin/orders/replace", limit(requirePermission("orders", handleAdminOrderReplaceResubmit)))
	http.HandleFunc("/api/admin/orders/retry", limit(requirePermission("orders", handleAdminOrderRetry)))
